...
Remember that the most important thing is getting the correct answer. Start by thinking of the right answer than then provide your reasoning.
"""
            ...
            if tokenize_fn is None:
                ...
                tokenized_dataset = dataset.map(
                    lambda x: {
                        ...
                        "label": x["label"] if "label" in x else None,
                        "is_train": x["is_train"],
                    },
                    batched=False,
                )
